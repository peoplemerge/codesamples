...
public class Dorothy {
	...
	public void goOnAdventure() {
		...
		questHandler.handle(Operation.ASK_GLINDA_FOR_HELP_AS_WESTWITCH_THREATENS, "I didn't mean to kill anyone. " +
				"It was an accident.");
		questHandler.handle(Operation.FIND_WIZARD_OF_OZ, "We'll soon find the Wizard.");
		questHandler.handle(Operation.GET_CAPTURED_BY_WITCH,  "All in good time, my little pretty -- all in good " +
				"time. Give me those slippers.");
		...
		questHandler.handle(Operation.CLICK_HEELS, "Now, those magic slippers will take you home in two seconds! " +
